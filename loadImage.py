...
def loadObject(rotationStart,endR,obj,base,endR2):
...
def load():
    ...
    i=0
    for j in objets:
       imagesLearn[j]=loadObject(rotationStarts[i]+1,endRs[i],j,'training',endR2s[i])
       imagesTest[j]=loadObject(rotationStarts[i]+1,endRs[i],j,'test',endR2s[i])
       i=i+1;
